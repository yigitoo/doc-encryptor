...
import ftfy
'''
@brief: Class for encrypt .doc/docx files.
'''
class Decryptor:
    file_data: str
    ...
    def __init__(self, file_data: str = None):
        ...
        if result != True:
            print(f"\nError cannot encrypt this file.")
    ...
    def decode_rot13(self, data: str = None) -> str | None:
        if data is not None:
...
if __name__ == "__main__":
    file = open('encrypted_data/enc_data.dat', 'r').read()
    decryptor = Decryptor(file)